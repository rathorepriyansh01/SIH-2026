...
export default function Scan() {
  ...
  const handleAnalyze = async (file) => {
    ...
    try {
      // Create image preview before sending to backend
      ...
      if (data && data.disease) {
        ...
        // Send both prediction result + uploaded image
        navigate('/result', {
          state: {
            resultData: data,
            imageUrl: imageUrl
    ...
    <div className="max-w-4xl mx-auto px-4 py-8 space-y-8">
      ...
      <div className="text-center">
        ...
        <p className="text-sm text-slate-400">
          Upload a high-resolution image of a tomato leaf
          to get instant disease diagnosis & management guide.
        </p>
